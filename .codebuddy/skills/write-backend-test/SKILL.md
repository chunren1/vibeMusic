...
description: >
  Generate unit/integration tests for Spring Boot Service and Controller classes.
  Trigger when user asks to write tests for a specific backend class or method.
---
...
### 0. 从模板开始
复制模板文件作为起点：
- Service 单元测试：`assets/service-test-template.java`
- Controller 集成测试：`assets/controller-test-template.java`
