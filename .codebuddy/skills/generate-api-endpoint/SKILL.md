...
description: >
  Generate full-stack API endpoints from a spec (endpoint path, request/response format,
  business rules). Creates Controller, Service, test, SecurityConfig, and frontend API calls.
  Trigger when user provides an API contract or asks to create a new endpoint.
---
