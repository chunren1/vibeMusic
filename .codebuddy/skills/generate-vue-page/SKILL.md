...
description: >
  Create new Vue pages for both desktop and mobile views. Trigger when user says
  "新建一个XX页面", "添加XX功能的前端页面", or requests a new frontend view.
---
...
## 0. 从模板开始
复制模板文件作为起点，避免重复写脚手架：
- 桌面端：`assets/desktop-template.vue`
- 移动端：`assets/mobile-template.vue`
