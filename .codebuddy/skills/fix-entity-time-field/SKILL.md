---
name: fix-entity-time-field
description: >
  Fix MyBatis-Plus entity time field auto-fill bugs caused by @Builder/@AllArgsConstructor
  overriding MySQL DEFAULT CURRENT_TIMESTAMP. Trigger when user says "XX表的时间字段为空",
  "时间不自动填", or when creating new entity classes.
---
...
- Playlist.createdAt — 正确
- PlaylistSong.addedAt — 正确